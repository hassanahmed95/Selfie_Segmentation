...
img =  cv2.imread("/home/hassan/Coding_Stuff/Online_projects/Selfie-Segmentation-Code/API/cv_api/3.jpeg")
res, image=  face_extraction(img,predictor,detector,segmentor)
